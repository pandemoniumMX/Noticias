...
'<label>Usuario</label>' +
'<input input type="text" name="usu" id="usu" required pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s,. ]+" title="Sólo letras" class="form-control border-input" maxlength="20" required>' +
